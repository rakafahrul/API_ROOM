...
// UPDATED: Configure Kestrel to listen on any IP
builder.WebHost.ConfigureKestrel(serverOptions => {
    serverOptions.ListenAnyIP(5228); // HTTP - accessible from any IP
    serverOptions.ListenAnyIP(7143, listenOptions => {
        listenOptions.UseHttps();
    });
});
...
// UPDATED: Comment out HTTPS redirect for mobile testing
// app.UseHttpsRedirection(); // Comment this for HTTP testing
...
try
{
    ...
    Console.WriteLine("HTTP: http://192.168.33.241:5228");
    Console.WriteLine("HTTPS: https://192.168.33.241:7143");
    Console.WriteLine("Swagger: http://192.168.33.241:5228/swagger");
